...
import random
import numpy as np
from SfMLearner_2 import SfMLearner
import os
...
flags.DEFINE_integer("num_source", None, "number of source images")     ### add 3/9
flags.DEFINE_integer("num_scales", None, "number of used image scales")  ### add 3/9
FLAGS = flags.FLAGS
